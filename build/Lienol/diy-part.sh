...
# 后台IP设置
export Ipv4_ipaddr="192.168.31.4"            # 修改openwrt后台地址(填0为关闭)
export Netmask_netm="255.255.255.0"         # IPv4 子网掩码（默认：255.255.255.0）(填0为不作修改)
export Op_name="OpenWrt-Lienol"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export DNS_Settings="202.96.128.166"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
